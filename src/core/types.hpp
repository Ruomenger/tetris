...
enum class GameState : uint8_t { Ready, Playing, Paused, GameOver };
...
enum class GameError : uint8_t { InvalidState, MoveBlocked, GameOver };

enum class BoardError : uint8_t { Collision, InvalidPosition };
